...
const handleSubmit = () => {
  ...
  // Validate warmup songs (Package #3 specific)
  ...
  // Validate ultimate package features
  if (!localFormData.value.goalHorn || !localFormData.value.goalHorn.trim()) {
    alert('Please provide your goal horn preference')
    return
  }
  
  if (!localFormData.value.winSong || !localFormData.value.winSong.trim()) {
    alert('Please provide your victory celebration song')
    return
  }
