      ...
      <div v-else-if="metrics" class="space-y-8">
        ...
        <div class="card p-8">
          <div class="flex items-center justify-between mb-6">
            ...
            <button class="text-brand-400 hover:text-brand-300 font-medium transition-colors">
              View all →
            </button>
          </div>
            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="py-4 px-4 text-white font-semibold">{{ formatPrice(transaction.amount) }}</td>
                  <td class="py-4 px-4">
                    <span 
