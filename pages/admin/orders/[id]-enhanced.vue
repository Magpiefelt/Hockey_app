    ...
    <div v-else-if="orderData" class="space-y-6">
      ...
      <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="text-white font-medium">
                  {{ orderData.order.serviceType || 'Custom' }}
                </p>
              </div>
              <div>
          ...
          <div class="bg-dark-secondary border border-white/10 rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
              <h2 class="text-2xl font-bold text-white">Quote</h2>
        ...
        <div class="space-y-6">
          <!-- Email History -->
          <OrderEmailHistory :order-id="orderId" />
      ...
      <div class="bg-dark-secondary border border-white/10 rounded-lg p-6">
        ...
        <!-- Deliverables -->
        <div v-if="deliverableFiles.length > 0" class="mb-6">
