...
-- Contact submissions table (contact form entries)
...
-- Calendar blocks table (for availability management)
...
CREATE INDEX IF NOT EXISTS idx_calendar_blocks_date ON calendar_blocks(blocked_date);
